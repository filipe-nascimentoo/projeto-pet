...
CREATE TABLE IF NOT EXISTS `pet` (
  ...
  `adotado` char(1) NOT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=78 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

-- Copiando dados para a tabela db_adote_pet.pet: ~8 rows (aproximadamente)
INSERT INTO `pet` (`id`, `nome`, `raca`, `porte`, `data_nascimento`, `observacao`, `cor`, `sexo`, `castrado`, `adotado`) VALUES
	(4, 'Toby', 'Salsichinha', 'Pequeno', '2020-06-01', 'Encontrada na rua', 'Mestiço', 'M', '1', '1'),
	(5, 'Bili', 'Dálmata', 'Grande', '2019-05-23', '', 'Cinza', 'M', '1', '1'),
	(6, 'Meg', 'Pinscher', 'Pequeno', '2013-05-03', '', 'Cinza', 'F', '1', '1'),
	(7, 'Caramelo', 'Viralata', 'Medio', '2022-06-03', '', 'Caramelo', 'M', '0', '1'),
	(8, 'Bilu', 'Labrador', 'Medio', '2024-03-03', '', 'Caramelo', 'M', '0', '1'),
	(11, 'Rex', 'Labrador', 'Grande', '2021-01-01', 'Muito ativo', 'Marrom', 'M', '1', '1'),
	(12, 'Luna', 'Siamês', 'Pequeno', '2022-03-15', 'Calma e carinhosa', 'Branco', 'F', '0', '1'),
	(14, 'Nala', 'Persa', 'Pequeno', '2020-11-25', 'Independente', 'Cinza', 'F', '1', '1');
